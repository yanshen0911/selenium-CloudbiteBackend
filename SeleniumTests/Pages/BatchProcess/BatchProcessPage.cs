...

{
    public class BatchProcessPage
    {
        ...
        [FindsBy(How = How.XPath, Using = "//td[contains(@class, 'text-end')]//a[contains(text(), 'Download')]")]
        ...
        // New Elements
        [FindsBy(How = How.XPath, Using = "/html/body/app-layout/div/div/div/div/app-content/app-setting/div/div/div/div/div[1]/div[2]/input")]
        public IWebElement ConvertCutOffInput { get; set; }

        [FindsBy(How = How.XPath, Using = "/html/body/app-layout/div/div/div/app-header/div/app-topbar/app-side-setting/div/div[2]/div[1]/input")]
        public IWebElement ConvertCutOffInputQS { get; set; }

        [FindsBy(How = How.XPath, Using = "/html/body/app-layout/div/div/div/div/app-content/app-setting/div/div/div/div/div[2]/div[2]/input")]
        public IWebElement ConsolidateCutOffInput { get; set; }

        [FindsBy(How = How.XPath, Using = "/html/body/app-layout/div/div/div/app-header/div/app-topbar/app-side-setting/div/div[2]/div[2]/input")]
        ...
        [FindsBy(How = How.XPath, Using = "/html/body/app-layout/div/div/div/div/app-content/app-setting/div/div/div/div/div[6]/div/button")]
        ...
        public void SetCheckboxState(bool isChecked)
        {
            var checkbox = _wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(
                By.XPath("/html/body/app-layout/div/div/div/div/app-content/app-setting/div/div/div/div/div[3]/div[2]/label/input")
            ));
        ...
        {
            var checkbox = _wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(
                By.XPath("/html/body/app-layout/div/div/div/app-header/div/app-topbar/app-side-setting/div/div[2]/div[3]/label[2]/input")
            ));
