...
namespace SeleniumTests.Tests.Setting
{
    ...
    public class Setting_Valid
    {
        ...
        public void OneTimeSetUp()
        {
            ...
            string moduleName = "Setting Page"; // You can make this dynamic if needed
        ...
        [AllureStory("Create")]
        [TestCase("3", "4", "true")]
        public void Create_New_Setting(string CutOffDate, string ConsolidateCutOffDate, string securityToken)
        {
            ...
            try
            {
                ...
                var fileInput = wait.Until(ExpectedConditions.ElementExists(
                    By.CssSelector("#kt_content_container > app-setting > div > div > div > div > div:nth-child(4) > div.col-sm-12.col-md-7.row.align-items-center > input[type='file']")));
