...
namespace QASErpPlusAutomation.Tests.Store
{
    [TestFixture]
    [AllureNUnit]
    [AllureSuite("Store - Store Region - Valid")] // use this ties to module
    [AllureEpic("ERP-117")] // use this and ties to ticket number
    public class StoreRegionTests_Valid
    {
        ...
        public void SetUp()
        {
            ...
            _driver.Navigate().GoToUrl(AppConfig.BaseUrl + "/store-stepper/store-region-v2");
            helperFunction.WaitForPageToLoad(_wait);
        ...
        [Test]
        [Category("StoreRegion")]
        [Order(1)]
        [AllureSeverity(SeverityLevel.normal)]
        [AllureStory("Store Store Region Create")]
        [TestCase("QATEST", "QA TEST DESC", "QA TEST OTHER DESC")]
        public void Create(string Code, string Desc,string OtherDesc)
        {
            ...
            helperFunction.TakeScreenshot(_driver, "Store", "Store", "Store Region", "1");
        ...
        [AllureStory("Store Store Region Search")]
        [TestCase("QATEST")]
        ...
        [TestCase("QATEST", "QA TEST DESC UPDATED", "QA TEST OTHER DESC UPDATED")]
