...
namespace QASErpPlusAutomation.Tests.Store
{
    [TestFixture]
    [AllureNUnit]
    [AllureSuite("Store - Store Terminal - Valid")] // use this ties to module
    [AllureEpic("ERP-117")] // use this and ties to ticket number
    public class StoreTerminalTests_Valid
    {
        private IWebDriver _driver;
        private StoreTerminalPage _page;
        ...
        public void SetUp()
        {
            ...
            _driver.Navigate().GoToUrl(AppConfig.BaseUrl + "/store-stepper/terminal-class-v2");
            helperFunction.WaitForPageToLoad(_wait);

            _page = new StoreTerminalPage(_driver);
            dashboardPage = new SeleniumTests.Pages.Dashboard(_driver);
        }

        [Test]
        [Category("StoreTerminal")]
        [Order(1)]
        [AllureSeverity(SeverityLevel.normal)]
        [AllureStory("Store Store Terminal Create")]
        ...
        [AllureStory("Store Store Terminal Search")]
        [TestCase("STTEST")]
        ...
        [Order(3)]
        [AllureSeverity(SeverityLevel.normal)]
        [AllureStory("Edit Store Terminal")]
        ...
        [Order(5)]
        [AllureSeverity(SeverityLevel.normal)]
        [AllureStory("Delete Store Terminal")]
        [TestCase("STTEST", "ST TEST DESC UPDATED", "ST TEST OTHER DESC UPDATED")]
